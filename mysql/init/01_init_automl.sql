...
CREATE TABLE IF NOT EXISTS `annotation_sample_assignment` (
    ...
    `is_deleted` TINYINT(1) DEFAULT 0 COMMENT '逻辑删除标记',
    PRIMARY KEY (`id`),
    UNIQUE KEY `uk_annotation_assignment_sample` (
        `annotation_id`,
        `sample_item_id`
    ),
    ...
    KEY `idx_annotation_assignment_collaborator` (
        `annotation_id`,
        `collaborator_id`
    )
...
CREATE TABLE IF NOT EXISTS `training_runtime_code_package` (
    ...
    `class_names_json` LONGTEXT NOT NULL COMMENT '可选固定类别顺序 JSON',
...
CREATE TABLE IF NOT EXISTS `ai_pipeline_binding` (
    ...
    `is_deleted` TINYINT(1) DEFAULT 0 COMMENT '逻辑删除标记',
    PRIMARY KEY (`id`),
    KEY `idx_ai_pipeline_binding_target` (
        `binding_type`,
        `binding_target_id`
    ),
    KEY `idx_ai_pipeline_binding_template` (
        `template_id`,
        `template_version`
    ),
    KEY `idx_ai_pipeline_binding_default` (
        `binding_type`,
        `binding_target_id`,
        `is_default`
    )
...
VALUES (
        'yolov8n.pt',
        'detection',
        'YOLOv8 nano detection baseline',
        'yolov8n.pt'
    ),
    (
        'yolov8s.pt',
        'detection',
        'YOLOv8 small detection baseline',
        'yolov8s.pt'
    ),
    (
        'yolov8m.pt',
        'detection',
        'YOLOv8 medium detection baseline',
        'yolov8m.pt'
    ),
    (
        'yolov8l.pt',
        'detection',
        'YOLOv8 large detection baseline',
        'yolov8l.pt'
    ),
    (
        'yolov8x.pt',
        'detection',
        'YOLOv8 extra-large detection baseline',
        'yolov8x.pt'
    ),
    (
        'yolov8n-obb.pt',
        'detection_obb',
        'YOLOv8 nano OBB detection baseline',
        'yolov8n-obb.pt'
    ),
    (
        'yolov8s-obb.pt',
        'detection_obb',
        'YOLOv8 small OBB detection baseline',
        'yolov8s-obb.pt'
    ),
    (
        'yolov8m-obb.pt',
        'detection_obb',
        'YOLOv8 medium OBB detection baseline',
        'yolov8m-obb.pt'
    ),
    (
        'yolov8l-obb.pt',
        'detection_obb',
        'YOLOv8 large OBB detection baseline',
        'yolov8l-obb.pt'
    ),
    (
        'yolov8x-obb.pt',
        'detection_obb',
        'YOLOv8 extra-large OBB detection baseline',
        'yolov8x-obb.pt'
    ),
    (
        'yolo11n.pt',
        'detection',
        'YOLO11 nano detection baseline',
        'yolo11n.pt'
    ),
    (
        'yolo11s.pt',
        'detection',
        'YOLO11 small detection baseline',
        'yolo11s.pt'
    ),
    (
        'yolo11m.pt',
        'detection',
        'YOLO11 medium detection baseline',
        'yolo11m.pt'
    ),
    (
        'yolo11l.pt',
        'detection',
        'YOLO11 large detection baseline',
        'yolo11l.pt'
    ),
    (
        'yolo11x.pt',
        'detection',
        'YOLO11 extra-large detection baseline',
        'yolo11x.pt'
    ),
    (
        'yolo11n-obb.pt',
        'detection_obb',
        'YOLO11 nano OBB detection baseline',
        'yolo11n-obb.pt'
    ),
    (
        'yolo11s-obb.pt',
        'detection_obb',
        'YOLO11 small OBB detection baseline',
        'yolo11s-obb.pt'
    ),
    (
        'yolo11m-obb.pt',
        'detection_obb',
        'YOLO11 medium OBB detection baseline',
        'yolo11m-obb.pt'
    ),
    (
        'yolo11l-obb.pt',
        'detection_obb',
        'YOLO11 large OBB detection baseline',
        'yolo11l-obb.pt'
    ),
    (
        'yolo11x-obb.pt',
        'detection_obb',
        'YOLO11 extra-large OBB detection baseline',
        'yolo11x-obb.pt'
    ),
    (
        'yolov8n-cls.pt',
        'classification',
        'YOLOv8 nano classification baseline',
        'yolov8n-cls.pt'
    ),
    (
        'yolov8s-cls.pt',
        'classification',
        'YOLOv8 small classification baseline',
        'yolov8s-cls.pt'
    ),
    (
        'yolov8m-cls.pt',
        'classification',
        'YOLOv8 medium classification baseline',
        'yolov8m-cls.pt'
    ),
    (
        'yolov8l-cls.pt',
        'classification',
        'YOLOv8 large classification baseline',
        'yolov8l-cls.pt'
    ),
    (
        'yolov8x-cls.pt',
        'classification',
        'YOLOv8 extra-large classification baseline',
        'yolov8x-cls.pt'
    ),
    (
        'yolo11n-cls.pt',
        'classification',
        'YOLO11 nano classification baseline',
        'yolo11n-cls.pt'
    ),
    (
        'yolo11s-cls.pt',
        'classification',
        'YOLO11 small classification baseline',
        'yolo11s-cls.pt'
    ),
    (
        'yolo11m-cls.pt',
        'classification',
        'YOLO11 medium classification baseline',
        'yolo11m-cls.pt'
    ),
    (
        'yolo11l-cls.pt',
        'classification',
        'YOLO11 large classification baseline',
        'yolo11l-cls.pt'
    ),
    (
        'yolo11x-cls.pt',
        'classification',
        'YOLO11 extra-large classification baseline',
        'yolo11x-cls.pt'
    ),
    (
        'yolov8n-seg.pt',
        'segmentation',
        'YOLOv8 nano segmentation baseline',
        'yolov8n-seg.pt'
    ),
    (
        'yolov8s-seg.pt',
        'segmentation',
        'YOLOv8 small segmentation baseline',
        'yolov8s-seg.pt'
    ),
    (
        'yolov8m-seg.pt',
        'segmentation',
        'YOLOv8 medium segmentation baseline',
        'yolov8m-seg.pt'
    ),
    (
        'yolov8l-seg.pt',
        'segmentation',
        'YOLOv8 large segmentation baseline',
        'yolov8l-seg.pt'
    ),
    (
        'yolov8x-seg.pt',
        'segmentation',
        'YOLOv8 extra-large segmentation baseline',
        'yolov8x-seg.pt'
    ),
    (
        'yolo11n-seg.pt',
        'segmentation',
        'YOLO11 nano segmentation baseline',
        'yolo11n-seg.pt'
    ),
    (
        'yolo11s-seg.pt',
        'segmentation',
        'YOLO11 small segmentation baseline',
        'yolo11s-seg.pt'
    ),
    (
        'yolo11m-seg.pt',
        'segmentation',
        'YOLO11 medium segmentation baseline',
        'yolo11m-seg.pt'
    ),
    (
        'yolo11l-seg.pt',
        'segmentation',
        'YOLO11 large segmentation baseline',
        'yolo11l-seg.pt'
    ),
    (
        'yolo11x-seg.pt',
        'segmentation',
        'YOLO11 extra-large segmentation baseline',
        'yolo11x-seg.pt'
    );
...
CREATE TABLE IF NOT EXISTS `ai_pipeline_batch_run` (
    ...
    `batch_group_id` VARCHAR(64) DEFAULT NULL COMMENT '连续增量批量标注分组ID',
...
CREATE TABLE IF NOT EXISTS `ai_pipeline_batch_run_item` (
    ...
    `finished_at` DATETIME DEFAULT NULL,
    PRIMARY KEY (`id`),
    UNIQUE KEY `uk_ai_pipeline_batch_run_item_sample` (
        `batch_run_id`,
        `sample_item_id`
    ),
