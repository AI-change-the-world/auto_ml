...
async def check_ai_platform_health():
    ...
    try:
        ...
        if is_healthy:
            ...
            logger.warning("AI Platform health check: FAILED - Service may be unavailable")
...
def start_scheduler():
    ...
    scheduler.start()
    logger.info(f"Scheduler started, heartbeat interval: {settings.heartbeat_interval}s")
