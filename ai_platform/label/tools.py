...
def base64_to_pil_image(base64_str: str, width:int = 1024, height:int = 1024) -> Image:
    if "," in base64_str:
        base64_str = base64_str.split(",")[1]
    return Image.open(io.BytesIO(base64.b64decode(base64_str))).convert("RGB").resize((width, height))
