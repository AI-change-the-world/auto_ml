...
img1 = lpips.im2tensor(lpips.load_image("D:/github_repo/auto_ml/ai_platform/gan/good/0.png")).cuda()
img2 = lpips.im2tensor(lpips.load_image("D:/github_repo/auto_ml/ai_platform/gan/good/0.png")).cuda()
